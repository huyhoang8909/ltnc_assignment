...
<?php echo theme_view('parts/breadcrumb/breadcrumb', array('page' => $page, 'pages' => $pages, 'item' => $item)) ?>

<?php echo theme_view('pages/single-product', array('page' => $page, 'pages' => $pages, 'item' => $item)) ?>
