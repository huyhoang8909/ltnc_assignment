...
class Migration_Install_cart_permissions extends Migration
{
	/**
	...
	private $permissionValues = array(
		array(
			'name' => 'Cart.Content.View',
			'description' => 'View Cart Content',
			'status' => 'active',
		),
		array(
			'name' => 'Cart.Content.Create',
			'description' => 'Create Cart Content',
			'status' => 'active',
		),
		array(
			'name' => 'Cart.Content.Edit',
			'description' => 'Edit Cart Content',
			'status' => 'active',
		),
		array(
			'name' => 'Cart.Content.Delete',
			'description' => 'Delete Cart Content',
			'status' => 'active',
		),
    );
