...
<div class='admin-box'>
    ...
    <?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
        <fieldset>
            ...
            <div class="control-group<?php echo form_error('PAYMENT_TYPE_ID') ? ' error' : ''; ?>">
                <div class='controls'>
                    <label class='checkbox' for='PAYMENT_TYPE_ID'>
                        <input type='checkbox' id='PAYMENT_TYPE_ID' name='PAYMENT_TYPE_ID'  value='1' <?php echo set_checkbox('PAYMENT_TYPE_ID', 1, isset($order->PAYMENT_TYPE_ID) && $order->PAYMENT_TYPE_ID == 1); ?> />
                        <?php echo lang('order_field_PAYMENT_TYPE_ID'); ?>
                    </label>
                    <span class='help-inline'><?php echo form_error('PAYMENT_TYPE_ID'); ?></span>
                </div>
            </div>
        ...
        <fieldset class='form-actions'>
            ...
            <?php echo lang('bf_or'); ?>
            <?php echo anchor(SITE_AREA . '/reports/order', lang('order_cancel'), 'class="btn btn-warning"'); ?>
            
            <?php if ($this->auth->has_permission('Order.Reports.Delete')) : ?>
                <?php echo lang('bf_or'); ?>
