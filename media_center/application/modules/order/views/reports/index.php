...
$num_columns	= 11;
$can_delete	= $this->auth->has_permission('Order.Reports.Delete');
$can_edit		= $this->auth->has_permission('Order.Reports.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class='table table-striped'>
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/reports/order/edit/' . $record->ORDER_ID, '<span class="icon-pencil"></span> ' .  $record->SHIPPING_TYPE_ID); ?></td>
				<?php else : ?>
