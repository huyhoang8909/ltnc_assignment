...
{
    protected $permissionCreate = 'Order.Settings.Create';
    protected $permissionDelete = 'Order.Settings.Delete';
    protected $permissionEdit   = 'Order.Settings.Edit';
    protected $permissionView   = 'Order.Settings.View';
    ...
    public function create()
    {
        ...
        if (isset($_POST['save'])) {
            if ($insert_id = $this->save_order()) {
                ...
                redirect(SITE_AREA . '/settings/order');
            }
