...
{
    protected $permissionCreate = 'Order.Developer.Create';
    protected $permissionDelete = 'Order.Developer.Delete';
    protected $permissionEdit   = 'Order.Developer.Edit';
    protected $permissionView   = 'Order.Developer.View';
    ...
    public function create()
    {
        ...
        if (isset($_POST['save'])) {
            if ($insert_id = $this->save_order()) {
                ...
                redirect(SITE_AREA . '/developer/order');
            }
