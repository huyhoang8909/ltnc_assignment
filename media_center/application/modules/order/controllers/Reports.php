...
{
    protected $permissionCreate = 'Order.Reports.Create';
    protected $permissionDelete = 'Order.Reports.Delete';
    protected $permissionEdit   = 'Order.Reports.Edit';
    protected $permissionView   = 'Order.Reports.View';
