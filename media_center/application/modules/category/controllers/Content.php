...
class Content extends Admin_Controller
{
    ...
    public function edit()
    {
        ...
        elseif (isset($_POST['delete'])) {
            ...
            if ($this->category_model->delete($id)) {
                log_activity($this->auth->user_id(), lang('category_act_delete_record') . ': ' . $id . ' : ' . $this->input->ip_address(), 'category');
    ...
    private function save_category($type = 'insert', $id = 0)
    {
        ...
        if (empty($data['CATEGORY_CATEGORY_ID'])) unset($data['CATEGORY_CATEGORY_ID']);
