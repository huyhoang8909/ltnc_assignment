...
class Migration_Install_item_permissions extends Migration
{
	/**
	...
	private $permissionValues = array(
		array(
			'name' => 'Item.Content.View',
			'description' => 'View Item Content',
			'status' => 'active',
		),
		array(
			'name' => 'Item.Content.Create',
			'description' => 'Create Item Content',
			'status' => 'active',
		),
		array(
			'name' => 'Item.Content.Edit',
			'description' => 'Edit Item Content',
			'status' => 'active',
		),
		array(
			'name' => 'Item.Content.Delete',
			'description' => 'Delete Item Content',
			'status' => 'active',
		),
    );
