 ...
 */
class CartItem extends \Entities\CartItem implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\CartItem' . "\0" . 'cartId', '' . "\0" . 'Entities\\CartItem' . "\0" . 'itemId'];
        }
