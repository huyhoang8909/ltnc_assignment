 ...
 */
class Promotion extends \Entities\Promotion implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\Promotion' . "\0" . 'promotionId', '' . "\0" . 'Entities\\Promotion' . "\0" . 'startDate', '' . "\0" . 'Entities\\Promotion' . "\0" . 'endDate', '' . "\0" . 'Entities\\Promotion' . "\0" . 'discountPercent', '' . "\0" . 'Entities\\Promotion' . "\0" . 'promotionCode'];
        }
    ...
    public function getPromotionId()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getPromotionId();
        }
    ...
    public function setPromotionCode($promotionCode)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPromotionCode', [$promotionCode]);

        return parent::setPromotionCode($promotionCode);
    }
    ...
    public function getPromotionCode()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPromotionCode', []);

        return parent::getPromotionCode();
    }
