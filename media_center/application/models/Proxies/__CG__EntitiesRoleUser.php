 ...
 */
class RoleUser extends \Entities\RoleUser implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\RoleUser' . "\0" . 'roleId', '' . "\0" . 'Entities\\RoleUser' . "\0" . 'userId'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RoleUser $proxy) {
