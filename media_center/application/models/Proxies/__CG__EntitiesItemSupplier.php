 ...
 */
class ItemSupplier extends \Entities\ItemSupplier implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\ItemSupplier' . "\0" . 'supplierId', '' . "\0" . 'Entities\\ItemSupplier' . "\0" . 'itemId'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ItemSupplier $proxy) {
    ...
    public function setSupplierId($supplierId)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSupplierId', [$supplierId]);
    ...
    public function getSupplierId()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getSupplierId();
        }
