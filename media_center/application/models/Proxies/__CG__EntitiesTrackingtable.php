 ...
 */
class Trackingtable extends \Entities\Trackingtable implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\Trackingtable' . "\0" . 'trackingId', '' . "\0" . 'Entities\\Trackingtable' . "\0" . 'position', '' . "\0" . 'Entities\\Trackingtable' . "\0" . 'time'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Trackingtable $proxy) {
    ...
    public function getTrackingId()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getTrackingId();
        }
