 ...
 */
class Reviews extends \Entities\Reviews implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\Reviews' . "\0" . 'reviewId', '' . "\0" . 'Entities\\Reviews' . "\0" . 'userId', '' . "\0" . 'Entities\\Reviews' . "\0" . 'itemId', '' . "\0" . 'Entities\\Reviews' . "\0" . 'rating', '' . "\0" . 'Entities\\Reviews' . "\0" . 'comment'];
        }
    ...
    public function getReviewId()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getReviewId', []);
