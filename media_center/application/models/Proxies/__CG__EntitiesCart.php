 ...
 */
class Cart extends \Entities\Cart implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\Cart' . "\0" . 'cartId', '' . "\0" . 'Entities\\Cart' . "\0" . 'userId', '' . "\0" . 'Entities\\Cart' . "\0" . 'status'];
        }
