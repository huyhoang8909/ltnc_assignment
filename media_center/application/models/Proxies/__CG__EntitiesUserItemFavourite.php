 ...
 */
class UserItemFavourite extends \Entities\UserItemFavourite implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\UserItemFavourite' . "\0" . 'userId', '' . "\0" . 'Entities\\UserItemFavourite' . "\0" . 'itemId'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (UserItemFavourite $proxy) {
