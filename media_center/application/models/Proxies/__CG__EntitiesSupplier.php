...
class Supplier extends \Entities\Supplier implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\Supplier' . "\0" . 'supplierId', '' . "\0" . 'Entities\\Supplier' . "\0" . 'supplierName', '' . "\0" . 'Entities\\Supplier' . "\0" . 'supplierType'];
        }
    ...
    public function setSupplierName($supplierName)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSupplierName', [$supplierName]);
    ...
    public function setSupplierType($supplierType)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSupplierType', [$supplierType]);
